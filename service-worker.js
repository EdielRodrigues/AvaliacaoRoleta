const CACHE_NAME = 'passadoria-v40-painel-agendamentos-retratil';
const APP_SHELL = [
  './',
  './index.html',
  './style.css',
...
self.addEventListener('fetch', (event) => {
  ...
  const isAppFile = url.origin === self.location.origin && (url.pathname.endsWith('/') || /\.(html|js|css|json)$/.test(url.pathname));
  if (isAppFile) {
